...
This creates the `man/` directory with .Rd files for all documented functions.
...
- **0 errors**
- **0 warnings**
- **0-1 notes** (NOTE about new package is acceptable)
...
Ensure you have write permissions in the data directory and sufficient disk space.

### Error: "Failed to download"

Check internet connectivity and firewall settings. Some data sources may be temporarily unavailable.
...
- [ ] Test coverage >80%
- [ ] No calls to `install.packages()` in code
- [ ] No `library()` calls in functions (use `::` or `requireNamespace()`)
